...
condsList = data.createFactorialTrialList({'ctpd_prime':[-80,-60,-40,-30,-20,-10,0,10,20,30,40,60,80], 
    'dsd_prime': [10], 'dsd_test':[5], 'dtype_prime':['norm'], 'dtype_test':['norm'], 'streak_length_prime':[2,3,5,6], 'prime_set_size':[36],'test_set_size':[36]})
...
for trial in trials:
    ...
    if  trial.totBlockN%20==0 and trial.trialN==0:
